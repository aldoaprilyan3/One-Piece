...
# Support
GROUP = os.environ.get("GROUP", "ChatBotXanon")
CHANNEL = os.environ.get("CHANNEL", "ChatBotXanon")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/RepoExtended/Man-Userbot.git"
)
...
# Bot version
BOT_VER = os.environ.get("BOT_VER", "0.9.8")
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/8f914f961402bc1048d5a.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/8f914f961402bc1048d5a.jpg"
)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**ተ AnonXbot ተ v{BOT_VER} is back up and running!**\n\n"
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@ChatBotXanon"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**ተ AnonXbot ተ Inline Menu **\n\nⲵ **Owner** [{user.first_name}](tg://user?id={user.id})\nⲵ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository ተ AnonXbot ተ",
                    url="https://t.me/SharingUserbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**ተ AnonXbot ተ**\n➖➖➖➖➖➖➖➖➖➖\nⲵ **Owner Repo :** [@xxstanme](https://t.me/xxstanme)\nⲵ **Support :** @ChatBotXanon\nⲵ **Repository :** [ተ AnonXbot ተ](https://telegra.ph/yhahaha-12-03)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/ChatBotXanon"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://telegra.ph/yhahaha-12-03"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    title="ተ AnonXbot ተ Userbot",
                    description="Join Grup Chat Klik Link Dibawah",
                    url="https://t.me/ChatBotXanon",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text=f"**ተ AnonXbot ተ**\n➖➖➖➖➖➖➖➖➖➖\nⲵ **UserMode:** [{user.first_name}](tg://user?id={user.id})\nⲵ **Assistant:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**Support:** @ChatBotXanon\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/ChatBotXanon"),
                            custom.Button.url(
