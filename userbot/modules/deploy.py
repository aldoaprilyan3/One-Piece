...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (aldoaprilyan3/One-Piece)",
        ...
        "INFO - One-Piece: Logged in as 557667062",
        "INFO - One-Piece: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Geez-Project -",
        "INFO - ☠️ One-Piece☠️ ⚙️ V5.1 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
