...
async def get_full_user(event):
    ...
    if event.reply_to_msg_id and not len(args) == 2:
        ...
        try:
            ...
            return await event.edit("`Terjadi Kesalahan... Mohon Support` @xthunderlol Lalu Laporkan kepada @RhitoSakai", str(err))
