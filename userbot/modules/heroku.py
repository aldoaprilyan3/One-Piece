...
async def dyno_usage(dyno):
    ...
    """
    await dyno.edit("`ᴍᴇɴᴅᴀᴘᴀᴛᴋᴀɴ ʙᴏᴜɴᴛʏ ᴍɪʟɪᴋ ꜱᴇɴꜱᴇɪ𒁂`")
    useragent = (
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(heroku_api + path, headers=headers) as r:
            ...
            await dyno.edit(
                "**𒈔 𝘉𝘰𝘶𝘯𝘵𝘺 𝘔𝘪𝘭𝘪𝘬 𝘚𝘦𝘯𝘴𝘦𝘪**\n\n**┏━━━━━━༻❁༺━━━━━━┓**\n**               𝑶𝑵𝑬 𝑷𝑰𝑬𝑪𝑬            **\n**┗━━━━━━༻❁༺━━━━━━┛**\n"
                f"𒄬 `𝘗𝘦𝘯𝘨𝘦𝘭𝘶𝘢𝘳𝘢𝘯 𝘉𝘰𝘶𝘯𝘵𝘺` **{app.name}**:\n"
                f"  𒆙 **{AppHours} Jam - "
                f"{AppMinutes} Menit  -  {AppPercentage}%**"
                "\n ◖══════════════════◗\n"
                "𒄬 `𝑷𝒆𝒏𝒅𝒂𝒑𝒂𝒕𝒂𝒏 𝑩𝒐𝒖𝒏𝒕𝒚 𝑩𝒖𝒍𝒂𝒏 𝑰𝒏𝒊`:\n"
                f"  𒆙 **{hours} Jam - {minutes} Menit  "
                f"-  {percentage}%**\n"
                "≫ ──── ≪•◦ ❈ ◦•≫ ──── ≪"
            )
