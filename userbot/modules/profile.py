...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "```Sorry Ni ye sensei Media Tidak Valid.```"
PP_CHANGED = "```Sensei, Foto Profil Anda Telah Berhasil Diubah.```"
PP_TOO_SMOL = "```Gambar Terlalu Kecil Sensei, Mohon Gunakan Yang Lebih Besar.```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah.```"

BIO_SUCCESS = "```Sensei, Bio Anda Telah Berhasil Diubah.```"

NAME_OK = "```Sensei, Nama Anda Telah Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah.```"
USERNAME_TAKEN = "```Mohon Maaf Sensei, Username Itu Sudah Ada Yang Menggunakannya.```"
# ===============================================================
