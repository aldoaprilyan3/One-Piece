    ...
    if HEROKU_API_KEY is not None:
        ...
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID, "#NOTE \n"
                "OK One Piece Berhasil Di Update")
...
async def update(event, repo, ups_rem, ac_br):
    ...
    if BOTLOG:
        await event.client.send_message(
            ...
            "OK BOT One Piece Berhasil Di Update")
        await asyncio.sleep(10)
        await event.delete()
...
async def upstream(event):
    ...
    await event.edit("`Mengecek Pembaruan Mohon Menunggu Sebentar....`")
    await event.edit("`Proses....`")
    await event.edit("`Oke Siap`")
    ...
    if force_update:
        ...
        await event.edit('`ᴘʀᴏꜱᴇꜱ ᴜᴘᴅᴀᴛᴇ ᴏɴᴇ ᴘɪᴇᴄᴇ ☠️, ....🛠️`')
        await event.edit('`ᴘʀᴏꜱᴇꜱ ᴜᴘᴅᴀᴛᴇ ᴏɴᴇ ᴘɪᴇᴄᴇ ☠️, 𝙻𝚘𝚊𝚍𝚒𝚗𝚐....🛠️`')
        await event.edit('`ᴘʀᴏꜱᴇꜱ ᴜᴘᴅᴀᴛᴇ ᴏɴᴇ ᴘɪᴇᴄᴇ ☠️, 𝚄𝚙𝚍𝚊𝚝𝚒𝚗𝚐....🛠️`')
        await event.edit('`ᴘʀᴏꜱᴇꜱ ᴜᴘᴅᴀᴛᴇ ᴏɴᴇ ᴘɪᴇᴄᴇ ☠️ Silahkan Menunggu Sebentar....🛠️`')
    if conf == "now":
