...
async def _(event):
    ...
    if event.pattern_match.group(1):
        ...
        await event.edit("`Sedang Mencari Lagu Yang Anda Inginkan....`")
    elif reply.message:
        query = reply.message
        await event.edit("`Sedang Mencari Lagu Yang Anda Inginkan....`")
    else:
        await event.edit("`Apa Yang Harus Saya Cari Sensei?`")
        return
    ...
    await event.edit("`Sedang Mengunggah Lagu Anda Sensei....`")
    c_time = time.time()
...
async def _(event):
    ...
    if event.pattern_match.group(1):
        query = event.pattern_match.group(1)
        await event.edit("`Mohon Menunggu Sensei, Sedang Mencari Musik Yang Anda Inginkan`")
    elif reply.message:
        query = reply.message
        await event.edit("`Telah Mendapatkan Musik, Sedang Mengunggah.....`")
    else:
        await event.edit("`Sensei, Apa Yang Seharusnya Saya Temukan? `")
        return
...
async def _(event):
    ...
    try:
        async with bot.conversation(chat) as conv:
            ...
            await event.edit("`Sedang Memproses... Mohon Menunggu Sebentar Sensei`")
            try:
