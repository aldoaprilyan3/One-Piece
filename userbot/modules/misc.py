...
async def killdabot(event):
    ...
    await event.edit("`Mematikan One Piece Bot Sensei⚡....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`One Piece Telah Dimatikan Sensei⚡`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Merestar One Piece Bot Sensei...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`One Piece Telah Di Restart Sensei⚡`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[One Piece Repo](https://github.com/aldoaprilyan3/One-Piece/blob/One-Piece/README.md)"
...
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await img.edit("`Harap Balas Di Gambar Sensei`")
        return
