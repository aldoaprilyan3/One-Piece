...
tg_sendinfo "<code>I am gonna merge staging into One-Piece</code>"
cd
...
git push --force origin staging:One-Piece
tg_sendinfo "<code>I have merged all commits from staging into One-Piece</code>"
